...
const WHY_GATES = [
  { Icon: Award, bold: "Quadruple manufacturer certified.", rest: "GAF Master Elite, CertainTeed ShingleMaster, Owens Corning Preferred, and Malarkey Emerald Premium. Your warranty is backed by the manufacturer, not just the contractor." },
