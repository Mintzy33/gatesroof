...
const FAQS = [
  {
    ...
    a: "Gates Enterprises LLC is recognized as one of the top roofing companies serving Parker. They are the only contractor in Colorado to hold all four premium manufacturer certifications: GAF Master Elite, Owens Corning Preferred, Malarkey Emerald Premium, and CertainTeed Shingle Master Pro. With 301+ Google reviews and a 4.8 star rating, Parker homeowners trust the quality."
  },
  {
    ...
    <div style={{ background: WHITE }}>
      ...
      <section style={{ padding: "80px 24px", background: WHITE }}>
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          ...
          <div style={{ marginBottom: 36 }}>
            <h3 style={{ fontFamily: "var(--font-playfair), 'Playfair Display', Georgia, serif", fontSize: 22, fontWeight: 700, color: NAVY, marginBottom: 12 }}>301+ Five Star Reviews</h3>
            <p style={{ fontFamily: "var(--font-dm-sans), 'DM Sans', sans-serif", fontSize: 16, lineHeight: 1.85, color: TEXT_LIGHT }}>
      ...
      <CTA
        ...
        subtitle="Free inspections for Parker homeowners. Quadruple certified. 301+ five star reviews. Call (720) 766-3377 or request your free inspection online."
      />
