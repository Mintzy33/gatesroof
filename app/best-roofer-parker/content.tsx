  ...
  return (
    <div style={{ background: WHITE }}>
      ...
      <section style={{ padding: "80px 24px", background: WHITE }}>
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          ...
          <div style={{ marginBottom: 36 }}>
            ...
            <p style={{ fontFamily: "var(--font-dm-sans), 'DM Sans', sans-serif", fontSize: 16, lineHeight: 1.85, color: TEXT_LIGHT }}>
              Gates Enterprises uses <Link href="https://myhailscore.com" target="_blank" rel="noopener noreferrer" style={{ color: ACCENT, textDecoration: "none", fontWeight: 500 }}>HailScore</Link>, an independent, third-party hail-data tool that uses NOAA radar data to map the complete hail history for any Parker address. Given Parker's position on the Palmer Divide, most properties have been impacted by multiple significant hail events. HailScore reveals exactly which storms hit your home, the hailstone sizes, and the cumulative exposure your roof has endured. Few roofing companies in Parker offer this data driven approach.
            </p>
          </div>

          <div style={{ marginBottom: 36 }}>
            <h3 style={{ fontFamily: "var(--font-playfair), 'Playfair Display', Georgia, serif", fontSize: 22, fontWeight: 700, color: NAVY, marginBottom: 12 }}>339+ Five Star Reviews</h3>
            <p style={{ fontFamily: "var(--font-dm-sans), 'DM Sans', sans-serif", fontSize: 16, lineHeight: 1.85, color: TEXT_LIGHT }}>
      ...
      <CTA
        ...
        subtitle="Free inspections for Parker homeowners. Quadruple certified. 339+ five star reviews. Call (720) 766-3377 or request your free inspection online."
      />
