...
export const metadata: Metadata = {
  ...
  description: "Looking for the best roofer in Parker, CO? Gates Enterprises is Colorado's only quadruple certified roofing contractor. 301+ Google reviews, 4.8 stars, HailScore technology. Free inspections. (720) 766-3377.",
  alternates: { canonical: "https://www.gatesroof.com/best-roofer-parker" },
  openGraph: {
    title: "Best Roofing Company in Parker, Colorado (2026)",
    description: "Looking for the best roofer in Parker? Gates Enterprises is Colorado's only quadruple certified roofing contractor. 301+ Google reviews, 4.8 stars.",
