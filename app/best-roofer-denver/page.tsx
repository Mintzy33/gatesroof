...
export const metadata: Metadata = {
  ...
  description: "Looking for the best roofer in Denver? Gates Enterprises is Colorado's only quadruple certified roofing contractor. 303+ Google reviews, 4.8 stars, proprietary HailScore technology. Free inspections. (720) 766-3377.",
  alternates: { canonical: "https://www.gatesroof.com/best-roofer-denver" },
  openGraph: {
    title: "Best Roofing Company in Denver, Colorado (2026)",
    description: "Looking for the best roofer in Denver? Gates Enterprises is Colorado's only quadruple certified roofing contractor. 303+ Google reviews, 4.8 stars. Free inspections.",
