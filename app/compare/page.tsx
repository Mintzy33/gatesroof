    ...
    <div style={{ background: WHITE }}>
      ...
      <section style={{ padding: "80px 24px", background: WHITE }}>
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          ...
          <p style={{ fontFamily: "var(--font-dm-sans), 'DM Sans', sans-serif", fontSize: 16, lineHeight: 1.85, color: TEXT_LIGHT, marginBottom: 20 }}>
            As Colorado's only quadruple certified roofing contractor with 303+ Google reviews and a 4.8 star rating, we are confident in where we stand. We would rather you compare the facts and choose us because you are convinced, not because you were pressured.
          </p>
