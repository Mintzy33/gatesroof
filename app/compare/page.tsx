...
export const metadata: Metadata = {
  ...
  description: "See how Colorado's only 4x certified roofer compares. 7,200+ roofs, 306 reviews, 4.8★. Transparent comparisons to help you choose. (720) 766-3377",
    ...
    <div style={{ background: WHITE }}>
      ...
      <section style={{ padding: "80px 24px", background: WHITE }}>
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          ...
          <p style={{ fontFamily: "var(--font-dm-sans), 'DM Sans', sans-serif", fontSize: 16, lineHeight: 1.85, color: TEXT_LIGHT, marginBottom: 20 }}>
            As Colorado's only quadruple certified roofing contractor with 306+ Google reviews and a 4.8 star rating, we are confident in where we stand. We would rather you compare the facts and choose us because you are convinced, not because you were pressured.
          </p>
