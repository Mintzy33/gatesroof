        ...
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          ...
          <div className="gates-advantage-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 20 }}>
            {[
              ...
              { title: "306+ Reviews, 4.9 Stars", desc: "Over 306 verified Google reviews from real Colorado homeowners with a 4.9 star average. Years of consistent five-star performance, not a flash in the pan." },
