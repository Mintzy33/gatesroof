  ...
  return (
    <div style={{ background: WHITE }}>
      ...
      <section style={{ padding: "160px 24px 80px", background: `linear-gradient(170deg, ${NAVY} 0%, #0F2A42 100%)`, position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ maxWidth: 800, margin: "0 auto", position: "relative", zIndex: 1 }}>
          ...
          <p style={{ fontFamily: "var(--font-dm-sans), 'DM Sans', sans-serif", fontSize: 17, color: ACCENT, fontWeight: 500, marginBottom: 20 }}>
            Lakewood's Own Quadruple Certified Roofing Contractor. 301+ Reviews. 4.8 Stars.
          </p>
        ...
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          ...
          <div style={{ marginBottom: 36 }}>
            ...
            <p style={{ fontFamily: "var(--font-dm-sans), 'DM Sans', sans-serif", fontSize: 16, lineHeight: 1.85, color: TEXT_LIGHT }}>
              Gates Enterprises LLC holds certifications from all four major shingle manufacturers: GAF Master Elite, Owens Corning Platinum Preferred, Malarkey Emerald Pro, and CertainTeed Shingle Master Pro. Fewer than 2% of roofers in the country hold even one of these. No other Colorado roofer holds all four. For Lakewood homeowners, this means the widest selection of premium products and the strongest warranty coverage available.
            </p>
          </div>

          <div style={{ marginBottom: 36 }}>
            <h3 style={{ fontFamily: "var(--font-playfair), 'Playfair Display', Georgia, serif", fontSize: 22, fontWeight: 700, color: NAVY, marginBottom: 12 }}>301+ Reviews and Counting</h3>
            <p style={{ fontFamily: "var(--font-dm-sans), 'DM Sans', sans-serif", fontSize: 16, lineHeight: 1.85, color: TEXT_LIGHT }}>
              With 301+ Google reviews and a 4.8 star average, Gates Enterprises has one of the strongest reputations of any roofing company in the Denver metro. Many of those reviews come from Lakewood homeowners who have seen the quality of their work firsthand. Consistent, verified reviews over years of service tell a much more reliable story than a handful of perfect ratings.
            </p>
          </div>
        ...
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          ...
          <div className="best-roofer-lkwd-certs" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 24, marginBottom: 32 }}>
            {[
              ...
              { name: "Owens Corning Platinum Preferred", desc: "Highest tier contractor status. Enhanced warranty programs and premium product access." },
              { name: "Malarkey Emerald Pro", desc: "Certified in Malarkey's advanced NEX Polymer Modified technology for Colorado's demanding climate." },
      ...
      <CTA
        ...
        subtitle="Free inspections from the quadruple certified roofer headquartered right here in Lakewood. 301+ five star reviews. Call (720) 766-3377 or request your free inspection online."
      />
