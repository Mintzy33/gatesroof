  ...
  return (
    <div style={{ background: WHITE }}>
      ...
      <section style={{ padding: "160px 24px 80px", background: `linear-gradient(170deg, ${NAVY} 0%, #0F2A42 100%)`, position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ maxWidth: 800, margin: "0 auto", position: "relative", zIndex: 1 }}>
          ...
          <p style={{ fontFamily: "var(--font-dm-sans), 'DM Sans', sans-serif", fontSize: 17, color: ACCENT, fontWeight: 500, marginBottom: 20 }}>
            Lakewood's Own Quadruple Certified Roofing Contractor. 306+ Reviews. 4.9 Stars.
          </p>
      ...
      <CTA
        ...
        subtitle="Free inspections from the quadruple certified roofer headquartered right here in Lakewood. 306+ five star reviews. Call (720) 766-3377 or request your free inspection online."
      />
