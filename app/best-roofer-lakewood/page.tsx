...
export const metadata: Metadata = {
  ...
  description: "Looking for the best roofer in Lakewood, CO? Gates Enterprises is headquartered in Lakewood and is Colorado's only quadruple certified roofing contractor. 301+ Google reviews, 4.8 stars. (720) 766-3377.",
  alternates: { canonical: "https://www.gatesroof.com/best-roofer-lakewood" },
  openGraph: {
    title: "Best Roofing Company in Lakewood, Colorado (2026)",
    description: "Gates Enterprises is headquartered in Lakewood and is Colorado's only quadruple certified roofing contractor. 301+ Google reviews, 4.8 stars.",
