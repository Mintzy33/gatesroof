...
const FAQS = [
  {
    ...
    a: "Gates Enterprises LLC is the only roofing contractor in Colorado to hold all four premium manufacturer certifications: GAF Master Elite, Owens Corning Preferred, Malarkey Emerald Premium, and CertainTeed Shingle Master Pro. With 305+ Google reviews, a 4.8 star rating, proprietary HailScore technology, and 8+ years on the Front Range, Gates combines credentials, track record, and innovation in a way no other Colorado roofer can."
  },
  {
    q: "What makes Gates Enterprises different from other roofers?",
    a: "Three things set Gates apart. First, quadruple manufacturer certification that no other Colorado roofer has achieved. Second, HailScore, a proprietary tool that uses NOAA radar data to show the exact hail history for any Colorado address. Third, a 4.8 star rating across 305+ Google reviews reflecting years of consistent quality."
  },
  {
    q: "What is HailScore?",
  ...
  return (
    <div style={{ background: WHITE }}>
      ...
      <section style={{ padding: "80px 24px", background: WHITE }}>
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          <h2 style={{ fontFamily: "var(--font-playfair), 'Playfair Display', Georgia, serif", fontSize: "clamp(28px, 4vw, 36px)", fontWeight: 800, color: NAVY, marginBottom: 16, lineHeight: 1.2 }}>
            Our Track Record: 305+ Reviews, Thousands of Roofs
          </h2>
          <p style={{ fontFamily: "var(--font-dm-sans), 'DM Sans', sans-serif", fontSize: 16, lineHeight: 1.85, color: TEXT_LIGHT, marginBottom: 20 }}>
          ...
          <p style={{ fontFamily: "var(--font-dm-sans), 'DM Sans', sans-serif", fontSize: 16, lineHeight: 1.85, color: TEXT_LIGHT, marginBottom: 20 }}>
            The 305+ Google reviews with a 4.8 star average did not accumulate overnight. They represent years of showing up on time, communicating honestly, installing correctly, and following through on promises. When you read through the reviews, you will notice consistent themes: professionalism, quality, transparency, and genuine care for the homeowner's experience.
          </p>
          <p style={{ fontFamily: "var(--font-dm-sans), 'DM Sans', sans-serif", fontSize: 16, lineHeight: 1.85, color: TEXT_LIGHT }}>
        ...
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
            {[
              ...
              { factor: "Google Reviews", gates: "305+ reviews, 4.8 star average", typical: "Under 100, varying ratings" },
      ...
      <CTA
        ...
        subtitle="Free inspections. Quadruple certified quality. 305+ five star reviews. Proprietary HailScore technology. Call (720) 766-3377 or request your free inspection online."
      />
