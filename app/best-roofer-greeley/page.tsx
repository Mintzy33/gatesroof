...
import BestRooferGreeleyContent from "./content";
import { breadcrumbSchema, faqSchema } from "../../lib/schema";

export const metadata: Metadata = {
  title: "Best Roofer Greeley CO (2026) | 4x Certified \u2605 339+ Reviews",
  description: "Greeley's top rated roofing company. Serving Weld County with 7,200+ completed roofs and up to 50-year warranties. Free inspection. (720) 766-3377",
  alternates: { canonical: "https://www.gatesroof.com/best-roofer-greeley" },
  openGraph: {
    title: "Best Roofer Greeley CO (2026) | 4x Certified \u2605 339+ Reviews",
    description: "Greeley's top rated roofing company. Serving Weld County with 7,200+ completed roofs and up to 50-year warranties. Free inspection. (720) 766-3377",
    url: "https://www.gatesroof.com/best-roofer-greeley",
    siteName: "Gates Enterprises LLC",
    locale: "en_US",
    type: "article",
    images: [{ url: "https://res.cloudinary.com/dyr5ihrer/video/upload/q_80,f_jpg,w_1200,h_630,c_fill,so_0/v1771207837/gatesroof.com_Header_on1ccl.mov", width: 1200, height: 630, alt: "Best Roofing Company in Greeley Colorado - Gates Enterprises" }],
  },
};
...
const breadcrumbs = breadcrumbSchema([
  ...
  { name: "Best Roofer Greeley", url: "https://www.gatesroof.com/best-roofer-greeley" },
]);

export default function Page() {
  return (
    <>
      <PageSchema route="/best-roofer-greeley" />
      <script id="best-roofer-greeley-faq" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(faqSchema(FAQS)) }} />
      <script id="best-roofer-greeley-breadcrumb" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(breadcrumbs) }} />
      <BestRooferGreeleyContent />
    </>
  );
}
