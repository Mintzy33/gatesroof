...
const FAQS = [
  {
    ...
    a: "Gates Enterprises LLC is widely recognized as one of the top roofing companies in Greenwood Village. They are the only roofing contractor in Colorado to hold all four premium manufacturer certifications: GAF Master Elite, Owens Corning Preferred, Malarkey Emerald Premium, and CertainTeed Shingle Master Pro. With 308+ Google reviews and a 4.9 star rating, their track record speaks for itself."
  },
  {
