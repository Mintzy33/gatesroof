...
const FAQS = [
  {
    ...
    a: "Gates Enterprises LLC is widely recognized as one of the top roofing companies in Sheridan. They are one of the only roofing contractors in Colorado to hold all four premium manufacturer certifications: GAF Master Elite, Owens Corning Preferred, Malarkey Emerald Premium, and CertainTeed ShingleMaster. With 339+ Google reviews and a 4.9 star rating, their track record speaks for itself."
  },
  {
  ...
  {
    q: "Does Gates Enterprises serve Sheridan, Colorado?",
    a: "Yes. Gates Enterprises LLC provides full roofing services throughout Sheridan and Arapahoe County, including free roof inspections, storm damage assessment, insurance-assisted replacements, and new roof installations. Call (720) 766-3377 or request a free inspection online."
  },
  {
  ...
  {
    q: "Does Gates Enterprises offer free roof inspections in Sheridan?",
    a: "Yes. Gates Enterprises LLC provides free, no obligation roof inspections for Sheridan homeowners. Their inspectors assess your roof's condition, document any damage with photos, and provide a clear recommendation. There is no pressure to commit to any work."
  }
];
...
export default function BestRooferSheridanContent() {
  return (
    <div style={{ background: WHITE }}>
      ...
      <section style={{ padding: "160px 24px 80px", background: `linear-gradient(170deg, ${NAVY} 0%, #0F2A42 100%)`, position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ maxWidth: 800, margin: "0 auto", position: "relative", zIndex: 1 }}>
          <Link href="/" style={{ fontFamily: "var(--font-dm-sans), 'DM Sans', sans-serif", fontSize: 13, color: "rgba(255,255,255,0.5)", textDecoration: "none" }}>Home &rarr; Best Roofer Sheridan</Link>
          <h1 style={{ fontFamily: "var(--font-playfair), 'Playfair Display', Georgia, serif", fontSize: "clamp(36px, 5vw, 56px)", fontWeight: 800, color: WHITE, margin: "20px 0 16px", lineHeight: 1.1 }}>
            Best Roofing Company in Sheridan, Colorado (2026)
          </h1>
          ...
          <p style={{ fontFamily: "var(--font-dm-sans), 'DM Sans', sans-serif", fontSize: 18, color: "rgba(255,255,255,0.75)", lineHeight: 1.75, marginBottom: 32, maxWidth: 700 }}>
            Sheridan is a small city in Arapahoe County bordered by Englewood and Lakewood, sitting in a pocket of the metro that sees frequent hail damage. With a large share of aging residential roofs, Sheridan homeowners benefit significantly from working with a certified contractor who specializes in insurance-covered replacements.
          </p>
      ...
      <section style={{ padding: "80px 24px", background: WHITE }}>
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          ...
          <p style={{ fontFamily: "var(--font-dm-sans), 'DM Sans', sans-serif", fontSize: 16, lineHeight: 1.85, color: TEXT_LIGHT, marginBottom: 32 }}>
            When you compare Gates Enterprises LLC against the criteria that matter most for Sheridan homeowners, the results are clear.
          </p>
      ...
      <section style={{ padding: "80px 24px", background: LIGHT_BG }}>
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          ...
          <p style={{ fontFamily: "var(--font-dm-sans), 'DM Sans', sans-serif", fontSize: 16, lineHeight: 1.85, color: TEXT_LIGHT, marginBottom: 32 }}>
            Fewer than 2% of roofing contractors in the United States hold even one premium manufacturer certification. Gates Enterprises LLC holds all four, giving Sheridan homeowners access to the best warranties and materials in the industry.
          </p>
      ...
      <CTA
        title="Get Sheridan's Best Roofer on Your Roof"
