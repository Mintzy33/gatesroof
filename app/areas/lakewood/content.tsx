      ...
      <section style={{ padding: "80px 24px", background: LIGHT_BG }}>
        <div style={{ maxWidth: 800, margin: "0 auto", marginBottom: 40 }}>
          ...
          <p style={{ fontFamily: "var(--font-dm-sans), 'DM Sans', sans-serif", fontSize: 16, lineHeight: 1.85, color: TEXT_LIGHT, marginBottom: 8 }}>
            We have earned 300+ Google reviews and a 4.9 star rating, and many of those reviews come from right here in Lakewood. When your neighbors trust us with their homes, that is the highest compliment we can receive. Here is what they have to say.
          </p>
