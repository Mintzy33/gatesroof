...
export const metadata: Metadata = {
  ...
  description: "Lakewood's own roofing company. 4x certified, thousands of roofs, 4.8★ from 300+ reviews. Roof replacement, hail damage repair & insurance claims. Call (720) 766-3377.",
