...
export const metadata: Metadata = {
  ...
  description: "Headquartered in Lakewood, CO. Your local roofer with 308+ five-star Google reviews and up to 50-year warranties. Call today for a free inspection.",
