    ...
    <div style={{ background: WHITE }}>
      ...
      <section style={{ padding: "160px 24px 80px", background: `linear-gradient(170deg, ${NAVY} 0%, #0F2A42 100%)` }}>
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          ...
          <p style={{ fontFamily: "var(--font-dm-sans), 'DM Sans', sans-serif", fontSize: 18, color: "rgba(255,255,255,0.75)", lineHeight: 1.75, marginBottom: 32, maxWidth: 700 }}>Westminster homeowners choose Gates Enterprises for reliable roofing services backed by four manufacturer certifications. We handle everything from hail damage inspections to full roof replacements.</p>
      ...
      <section style={{ padding: "80px 24px", background: WHITE }}>
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          ...
          <p style={{ fontFamily: "var(--font-dm-sans), 'DM Sans', sans-serif", fontSize: 16, lineHeight: 1.85, color: TEXT_LIGHT, marginBottom: 40 }}>Westminster sees its share of Colorado hailstorms every year. Our team provides free storm damage inspections and manages the entire insurance restoration process to ensure you get the coverage you deserve.</p>
      ...
      <CTA title={"Need a roofer in Westminster?"} subtitle="Call Gates Enterprises at (720) 766-3377 for a free inspection. No obligation, no pressure, just an honest assessment of your roof." />
      <Footer />
    </div>
  );
}
