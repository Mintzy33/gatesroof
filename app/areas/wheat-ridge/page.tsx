...
export const metadata: Metadata = {
  title: `Wheat Ridge Roofer | 4x Certified, ${SITE_STATS.reviewCount}+ Reviews ★`,
  description: `Wheat Ridge roofer with ${SITE_STATS.reviewCount}+ Google reviews and a ${SITE_STATS.starRating}-star average. Hail damage repair, roof replacement, and gutter installs. Locally operated. Free inspection.`,
...
export default function Page() {
  return (
    <>
      <PageSchema route="/areas/wheat-ridge" />
