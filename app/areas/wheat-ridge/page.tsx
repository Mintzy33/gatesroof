...
export const metadata: Metadata = {
  title: "Wheat Ridge Roofer | 4x Certified, 308+ Reviews ★",
  description: "Wheat Ridge roofer with 308+ five-star Google reviews. Hail damage repair, roof replacement, and gutter installs. Locally operated. Free inspection.",
