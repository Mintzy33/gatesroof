    ...
    <div style={{ background: WHITE }}>
      ...
      <section style={{ padding: "160px 24px 80px", background: `linear-gradient(170deg, ${NAVY} 0%, #0F2A42 100%)` }}>
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          ...
          <p style={{ fontFamily: "var(--font-dm-sans), 'DM Sans', sans-serif", fontSize: 18, color: "rgba(255,255,255,0.75)", lineHeight: 1.75, marginBottom: 32, maxWidth: 700 }}>Wheat Ridge homeowners are our neighbors. Gates Enterprises serves this community with expert roofing, siding, and gutter installation backed by four manufacturer certifications and a 4.8-star Google rating.</p>
      ...
      <section style={{ padding: "80px 24px", background: WHITE }}>
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          ...
          <p style={{ fontFamily: "var(--font-dm-sans), 'DM Sans', sans-serif", fontSize: 16, lineHeight: 1.85, color: TEXT_LIGHT, marginBottom: 40 }}>Wheat Ridge is right next door to our Lakewood home base. When storms hit, we are one of the first contractors on the ground, inspecting roofs and helping homeowners navigate the insurance process.</p>
      ...
      <CTA title={"Need a roofer in Wheat Ridge?"} subtitle="Call Gates Enterprises at (720) 766-3377 for a free inspection. No obligation, no pressure, just an honest assessment of your roof." />
      <Footer />
    </div>
  );
}
