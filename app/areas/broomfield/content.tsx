...
export default function CityContent() {
  const faqItems = getCityFAQItems("broomfield");
  return (
    <div style={{ background: WHITE }}>
      ...
      <section style={{ padding: "160px 24px 80px", background: `linear-gradient(170deg, ${NAVY} 0%, #0F2A42 100%)` }}>
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          ...
          <p style={{ fontFamily: "var(--font-dm-sans), 'DM Sans', sans-serif", fontSize: 17, color: ACCENT, fontWeight: 500, marginBottom: 20 }}>Broomfield County · HOA Communities · GAF Master Elite Certified · Thousands of Roofs</p>
          <p style={{ fontFamily: "var(--font-dm-sans), 'DM Sans', sans-serif", fontSize: 18, color: "rgba(255,255,255,0.75)", lineHeight: 1.75, marginBottom: 32, maxWidth: 700 }}>Broomfield is Colorado's only city that is also its own county, and it's one of the fastest growing tech corridor communities along the US 36 corridor. Gates Enterprises serves Broomfield's mix of HOA governed subdivisions and older ranch home neighborhoods, providing certified installation and full insurance restoration support in a city where hail events hit regularly.</p>
      ...
      <section style={{ padding: "80px 24px", background: WHITE }}>
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          ...
          <p style={{ fontFamily: "var(--font-dm-sans), 'DM Sans', sans-serif", fontSize: 16, lineHeight: 1.85, color: TEXT_LIGHT, marginBottom: 24 }}>Broomfield holds the unique distinction of being Colorado's only city county — its own independent county with its own permitting jurisdiction. That's a distinction that matters when you're pulling building permits for a roof replacement. Gates Enterprises is familiar with Broomfield County's permitting process and handles the submission, coordination, and inspection scheduling on every project we complete within city limits.</p>
          <p style={{ fontFamily: "var(--font-dm-sans), 'DM Sans', sans-serif", fontSize: 16, lineHeight: 1.85, color: TEXT_LIGHT, marginBottom: 24 }}>Broomfield is home to major technology employers like Oracle and Level 3 Communications, which has driven significant growth in the city's newer subdivisions. These HOA governed communities have specific requirements for roofing materials — approved colors, approved brands, and required documentation for HOA architectural review. Our team manages that process so homeowners in Broomfield's planned communities don't have to navigate it alone.</p>
          <p style={{ fontFamily: "var(--font-dm-sans), 'DM Sans', sans-serif", fontSize: 16, lineHeight: 1.85, color: TEXT_LIGHT, marginBottom: 40 }}>Broomfield also has established older neighborhoods with ranch homes from earlier decades — properties that are reaching the end of their original roofing system's life. These homes tend to be in excellent structural condition, with owners who have maintained them well, but the roof is often the last major system to be updated. We work with these homeowners to select materials that offer the best long term performance value.</p>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
            {[
              ...
              "Familiar with Broomfield County's unique permitting jurisdiction",
            ...
            <FAQAccordion
        items={faqItems}
        title="Frequently Asked Questions: Roofing in Broomfield, CO"
      />

<CTA title="Need a roofer in Broomfield?" subtitle="Call Gates Enterprises at (720) 766-3377 for a free inspection. We know Broomfield County permitting and handle all HOA approval documentation on your behalf." />
      ...
      <section style={{ padding: "64px 24px", background: LIGHT_BG }}>
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          ...
          <h2 style={{ fontFamily: "var(--font-playfair), 'Playfair Display', Georgia, serif", fontSize: "clamp(24px, 3.5vw, 30px)", fontWeight: 800, color: NAVY, margin: "10px 0 12px" }}>Services in Broomfield, CO</h2>
          <p style={{ fontFamily: "var(--font-dm-sans), 'DM Sans', sans-serif", fontSize: 15, color: TEXT_LIGHT, marginBottom: 24, lineHeight: 1.7 }}>Gates Enterprises provides a full range of roofing and exterior services in Broomfield.</p>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
            {[
              ...
              <Link key={svc.s} href={`/services/${svc.s}/broomfield`} style={{ display: "flex", alignItems: "center", gap: 8, fontFamily: "var(--font-dm-sans), 'DM Sans', sans-serif", fontSize: 15, color: ACCENT, textDecoration: "none", fontWeight: 500, padding: "8px 0" }}>
      ...
      <HailScoreCard citySlug="broomfield" cityName="Broomfield" />
      ...
      <section style={{ padding: "32px 24px", background: "#f8f9fb", borderTop: "1px solid rgba(13,33,55,0.06)" }}>
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          ...
          <a href="/best-roofer-broomfield" style={{ display: "inline-flex", alignItems: "center", gap: 6, fontFamily: "var(--font-dm-sans), 'DM Sans', sans-serif", fontSize: 15, color: "#1a56a4", fontWeight: 600, textDecoration: "none" }}>
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><polyline points="9 18 15 12 9 6" /></svg>
            Best Roofer in Broomfield, CO
          </a>
        </div>
      </section>
      <LocalSEOInfo citySlug="broomfield" cityName="Broomfield" showMapsLink />
