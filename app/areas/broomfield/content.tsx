...
export default function CityContent() {
  return (
    <div style={{ background: WHITE }}>
      ...
      <CTA title={"Need a roofer in Broomfield?"} subtitle="Call Gates Enterprises at (720) 766-3377 for a free inspection. No obligation, no pressure, just an honest assessment of your roof." />
      <Footer />
    </div>
  );
}
