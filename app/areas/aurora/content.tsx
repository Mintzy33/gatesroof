    ...
    <div style={{ background: WHITE }}>
      ...
      <section style={{ padding: "80px 24px", background: WHITE }}>
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          ...
          <p style={{ fontFamily: "var(--font-dm-sans), 'DM Sans', sans-serif", fontSize: 16, lineHeight: 1.85, color: TEXT_LIGHT, marginBottom: 40 }}>Aurora is one of Colorado most hail-prone cities. Our team responds quickly after storms and handles the entire insurance restoration process so you can focus on your family, not your roof.</p>
