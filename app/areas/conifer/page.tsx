...
export const metadata: Metadata = {
  ...
  description: "Conifer CO mountain roofing by a 4x certified contractor. Built for altitude, snow, and Colorado storms. 308+ five-star reviews. Free inspection.",
