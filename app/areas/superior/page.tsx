  ...
  "@graph": [
    {
      ...
      "description": "Quadruple manufacturer certified roofing contractor serving Superior, CO and Colorado's Front Range. GAF Master Elite, Owens Corning Preferred, Malarkey Emerald Pro, CertainTeed Shingle Master Pro. 300+ Google reviews, 4.8 stars.",
      "areaServed": [
        {
          "@type": "City",
          "name": "Superior",
