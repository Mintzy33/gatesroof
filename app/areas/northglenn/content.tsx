    ...
    <div style={{ background: WHITE }}>
      ...
      <section style={{ padding: "160px 24px 80px", background: `linear-gradient(170deg, ${NAVY} 0%, #0F2A42 100%)` }}>
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          ...
          <p style={{ fontFamily: "var(--font-dm-sans), 'DM Sans', sans-serif", fontSize: 18, color: "rgba(255,255,255,0.75)", lineHeight: 1.75, marginBottom: 32, maxWidth: 700 }}>Gates Enterprises serves Northglenn homeowners with expert roofing backed by four manufacturer certifications. From roof replacement to storm damage repair, we deliver quality you can count on.</p>
      ...
      <section style={{ padding: "80px 24px", background: WHITE }}>
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          ...
          <p style={{ fontFamily: "var(--font-dm-sans), 'DM Sans', sans-serif", fontSize: 16, lineHeight: 1.85, color: TEXT_LIGHT, marginBottom: 40 }}>Northglenn established neighborhoods deserve a roofing contractor who values quality over volume. We take the time to do it right. Proper tear off, deck inspection, and manufacturer spec installation on every roof.</p>
      ...
      <CTA title={"Need a roofer in Northglenn?"} subtitle="Call Gates Enterprises at (720) 766-3377 for a free inspection. No obligation, no pressure, just an honest assessment of your roof." />
      <Footer />
    </div>
  );
}
