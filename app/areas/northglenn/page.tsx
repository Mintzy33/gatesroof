...
export const metadata: Metadata = {
  title: "Northglenn CO Roofer | 4x Certified, 308+ Reviews ★",
  description: "Northglenn CO roofer with 4.9 stars and 308+ reviews. Full replacements, storm restoration, and insurance claims support. Get a free roof inspection.",
...
export default function Page() {
  return (
    <>
      <PageSchema route="/areas/northglenn" />
