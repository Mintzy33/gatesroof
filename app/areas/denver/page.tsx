...
export const metadata: Metadata = {
  ...
  description: "Denver's top-rated roofing contractor. 4x manufacturer certified, 294+ reviews, 4.8★. Storm damage, roof replacement, siding & gutters. Free inspection.",
