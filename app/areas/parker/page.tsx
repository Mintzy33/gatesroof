...
export const metadata: Metadata = {
  ...
  description: "Parker's #1 certified roofer. 7,200+ roofs, 4.8★ from 308 Reviews. GAF Master Elite + 3 more certs. Free hail inspections. Call (720) 766-3377",
  ...
  "@graph": [
    {
      ...
      "description": "Quadruple manufacturer certified roofing contractor serving Parker, CO and Colorado's Front Range. GAF Master Elite, Owens Corning Preferred, Malarkey Emerald Premium, CertainTeed Shingle Master Pro. 308 Google reviews, 4.8 stars. 7,200+ completed projects. Roof replacement, hail damage repair, and storm restoration for Parker homeowners along the Palmer Divide hail corridor.",
      "priceRange": "$$",
      "address": {
        "@type": "PostalAddress",
    ...
    },
    {
      ...
      "mainEntity": [
        ...
        },
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes. Gates Enterprises is an insurance restoration expert. We document all storm damage thoroughly, provide detailed reports with photo evidence, and work directly with your insurance company throughout the restoration process to ensure nothing is missed."
          }
        },
        {
          "@type": "Question",
    ...
    },
    {
      ...
      "description": "Complete roofing services for Parker, CO homeowners including roof replacement, storm damage restoration, roof repair, inspections, gutters, siding, windows, and painting. Quadruple manufacturer certified with 308 Google reviews and 4.8 stars.",
      "offers": {
        "@type": "Offer",
