        ...
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          ...
          <div style={{ marginBottom: 36 }}>
            ...
            <p style={{ fontFamily: "var(--font-dm-sans), 'DM Sans', sans-serif", fontSize: 16, lineHeight: 1.85, color: TEXT_LIGHT }}>
              Fewer than 2% of roofing contractors nationwide hold even one premium manufacturer certification. Gates Enterprises holds four: GAF Master Elite, Owens Corning Preferred, Malarkey Emerald Pro, and CertainTeed Shingle Master Pro. That means Brighton homeowners get access to the best warranty options and highest quality materials available.
            </p>
          </div>
          ...
          <div style={{ marginBottom: 36 }}>
            ...
            <p style={{ fontFamily: "var(--font-dm-sans), 'DM Sans', sans-serif", fontSize: 16, lineHeight: 1.85, color: TEXT_LIGHT }}>
              When a hailstorm damages your roof, the restoration process can feel overwhelming. Gates Enterprises LLC is an insurance restoration expert, guiding Brighton homeowners through the restoration process from initial inspection through final installation. We document damage thoroughly and work directly with your insurance company on your behalf.
            </p>
          </div>
