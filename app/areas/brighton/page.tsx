...
export const metadata: Metadata = {
  ...
  description: "Brighton's trusted 4x certified roofer. 7,200+ roofs completed, 4.8★ from 308 Reviews. Free storm damage inspections. Call (720) 766-3377 today",
  ...
  "@graph": [
    {
      ...
      "description": "Quadruple manufacturer certified roofing contractor serving Brighton, CO and Colorado's Front Range. GAF Master Elite, Owens Corning Preferred, Malarkey Emerald Premium, CertainTeed Shingle Master Pro. 300+ Google reviews, 4.8 stars.",
      "areaServed": [
        {
          "@type": "City",
          "name": "Brighton",
