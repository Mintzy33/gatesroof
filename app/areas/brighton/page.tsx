...
export const metadata: Metadata = {
  title: "Roofing Contractor in Brighton, CO | Gates Enterprises",
  description: "Brighton roofing experts. Roof replacement, hail damage repair, siding & gutters. 4x manufacturer certified. Free inspection. Call (720) 766-3377.",
  alternates: { canonical: "https://gatesroof.com/areas/brighton" },
  openGraph: {
    title: "Roofing Contractor in Brighton, CO | Gates Enterprises",
    description: "Brighton roofing experts. Roof replacement, hail damage repair, siding & gutters. 4x manufacturer certified. Free inspection. Call (720) 766-3377.",
    url: "https://gatesroof.com/areas/brighton",
...
const citySchema = {
  ...
  "geo": { "@type": "GeoCoordinates", "latitude": 39.9853, "longitude": -104.8206 },
  "areaServed": { "@type": "City", "name": "Brighton", "addressRegion": "CO" },
