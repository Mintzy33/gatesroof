...
export const metadata: Metadata = {
  title: "Roofing Contractor Lone Tree CO | Gates Enterprises",
  description: "Lone Tree's trusted roofing contractor. 4x certified, 300+ reviews, 4.8★. Roof replacement, hail damage repair & insurance claims. Free inspection. Call (720) 766-3377.",
  ...
  "@graph": [
    {
      ...
      "description": "Quadruple manufacturer certified roofing contractor serving Lone Tree, CO and Colorado's Front Range. GAF Master Elite, Owens Corning Preferred, Malarkey Emerald Pro, CertainTeed Shingle Master Pro. 300+ Google reviews, 4.8 stars.",
      "areaServed": [
        {
          "@type": "City",
          "name": "Lone Tree",
