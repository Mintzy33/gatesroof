...
export const metadata: Metadata = {
  ...
  description: "Golden roofing experts. Roof replacement, hail damage repair & insurance restoration. 4.8★ rated with thousands of roofs. Free estimate. Call (720) 766-3377.",
