...
export const metadata: Metadata = {
  title: `Golden CO Roofer | 4x Certified, ${SITE_STATS.reviewCount}+ Reviews ★`,
  description: `Golden CO roofing from a locally operated, 4x certified team. Foothills wind and hail damage repair. ${SITE_STATS.reviewCount}+ Google reviews. Book a free inspection.`,
