    ...
    <div style={{ background: WHITE }}>
      ...
      <section style={{ padding: "80px 24px", background: WHITE }}>
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          ...
          <p style={{ fontFamily: "var(--font-dm-sans), 'DM Sans', sans-serif", fontSize: 16, lineHeight: 1.85, color: TEXT_LIGHT, marginBottom: 40 }}>Golden unique location where the plains meet the mountains creates challenging weather patterns. High winds, hail, and intense UV exposure demand a roofing contractor who knows Colorado conditions inside and out.</p>
