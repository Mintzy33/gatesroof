  ...
  "@graph": [
    {
      ...
      "foundingDate": "2014",
      "description": "Quadruple manufacturer certified roofing contractor serving Evergreen, CO and Colorado's Front Range. GAF Master Elite, Owens Corning Preferred, Malarkey Emerald Premium, CertainTeed ShingleMaster. 300+ Google reviews, 4.9 stars.",
      "areaServed": [
        {
          "@type": "City",
          "name": "Evergreen",
