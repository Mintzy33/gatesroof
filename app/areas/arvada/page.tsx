...
export const metadata: Metadata = {
  title: `Arvada CO Roofer | 4x Certified, ${SITE_STATS.reviewCount}+ Reviews ★`,
  description: `Locally operated Arvada CO roofer. Hail damage, full replacements, and storm restoration. 4x certified, ${SITE_STATS.starRating} star rated. Call today for a free inspection.`,
