...
export const metadata: Metadata = {
  title: `Englewood CO Roofer | 4x Certified, ${SITE_STATS.reviewCount}+ Reviews ★`,
  description: `Englewood CO roofing contractor rated ${SITE_STATS.starRating} stars. Roof replacements, hail repair, and siding. Warranties up to 50 years. Get your free estimate today.`,
