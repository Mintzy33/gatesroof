...
export default function CityContent() {
  const faqItems = getCityFAQItems("thornton");
  return (
      ...
      <section style={{ padding: "80px 24px", background: WHITE }}>
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
            ...
            <FAQAccordion
        items={faqItems}
        title="Frequently Asked Questions: Roofing in Thornton, CO"
      />
...
<CTA title="Need a roofer in Thornton?" subtitle="Call Gates Enterprises at (720) 766-3377 for a free inspection. We give Thornton homeowners straight answers and certified quality without the sales pressure." />
      ...
      <section style={{ padding: "64px 24px", background: LIGHT_BG }}>
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          ...
          <h2 style={{ fontFamily: "var(--font-playfair), 'Playfair Display', Georgia, serif", fontSize: "clamp(24px, 3.5vw, 30px)", fontWeight: 800, color: NAVY, margin: "10px 0 12px" }}>Services in Thornton, CO</h2>
          <p style={{ fontFamily: "var(--font-dm-sans), 'DM Sans', sans-serif", fontSize: 15, color: TEXT_LIGHT, marginBottom: 24, lineHeight: 1.7 }}>Gates Enterprises provides a full range of roofing and exterior services in Thornton.</p>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
            {[
              ...
              <Link key={svc.s} href={`/services/${svc.s}/thornton`} style={{ display: "flex", alignItems: "center", gap: 8, fontFamily: "var(--font-dm-sans), 'DM Sans', sans-serif", fontSize: 15, color: ACCENT, textDecoration: "none", fontWeight: 500, padding: "8px 0" }}>
      ...
      <HailScoreCard citySlug="thornton" cityName="Thornton" />
      ...
      <section style={{ padding: "32px 24px", background: "#f8f9fb", borderTop: "1px solid rgba(13,33,55,0.06)" }}>
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          ...
          <a href="/best-roofer-thornton" style={{ display: "inline-flex", alignItems: "center", gap: 6, fontFamily: "var(--font-dm-sans), 'DM Sans', sans-serif", fontSize: 15, color: "#1a56a4", fontWeight: 600, textDecoration: "none" }}>
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><polyline points="9 18 15 12 9 6" /></svg>
            Best Roofer in Thornton, CO
          </a>
        </div>
      </section>
      <LocalSEOInfo citySlug="thornton" cityName="Thornton" showMapsLink />
