...
export const metadata: Metadata = {
  title: `Centennial CO Roofer | Hail Damage Experts, ${SITE_STATS.reviewCount} Reviews, ${SITE_STATS.starRating} Stars`,
  description: `Centennial hail season is here. Gates Enterprises: ${SITE_STATS.reviewCount} Google reviews (${SITE_STATS.starRating} stars), GAF Master Elite certified, ${SITE_STATS.totalRoofs} roofs replaced. Free hail inspection.`,
...
export default function Page() {
  return (
    <>
      <PageSchema route="/areas/centennial" />
