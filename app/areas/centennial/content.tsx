    ...
    <div style={{ background: WHITE }}>
      ...
      <section style={{ padding: "160px 24px 80px", background: `linear-gradient(170deg, ${NAVY} 0%, #0F2A42 100%)` }}>
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          ...
          <p style={{ fontFamily: "var(--font-dm-sans), 'DM Sans', sans-serif", fontSize: 17, color: ACCENT, fontWeight: 500, marginBottom: 20 }}>Arapahoe County · Premium Materials · GAF Master Elite Certified · HOA Experts</p>
        ...
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
            {[
              ...
              "4.9 star Google rating from 308+ verified reviews",
      ...
      <section style={{ padding: "64px 24px", background: WHITE }}>
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          ...
          <p style={{ fontFamily: "var(--font-dm-sans), 'DM Sans', sans-serif", fontSize: 16, lineHeight: 1.85, color: TEXT_LIGHT, marginBottom: 16 }}>These are some of Centennial's premium neighborhoods with larger lots and higher-end homes. Homeowners here expect top-tier materials and workmanship. Our quadruple manufacturer certification (GAF Master Elite, Owens Corning Preferred, Malarkey Emerald Premium, and CertainTeed ShingleMaster) means we can offer the highest warranty tiers available from any major manufacturer, including the GAF Golden Pledge 50-year warranty.</p>
      ...
      <section style={{ padding: "64px 24px", background: LIGHT_BG }}>
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          ...
          <p style={{ fontFamily: "var(--font-dm-sans), 'DM Sans', sans-serif", fontSize: 16, lineHeight: 1.85, color: TEXT_LIGHT, marginBottom: 24 }}>Gates Enterprises handles insurance restoration claims every day across Arapahoe County. We document damage with detailed photography, prepare Xactimate estimates that match what your insurance adjuster expects, and coordinate documentation with your insurance company throughout the process. Most homeowners only pay their deductible. <Link href="/services/insurance-claims" style={{ color: ACCENT, textDecoration: "none" }}>Learn more about our insurance claims process</Link>.</p>
...
<CTA title="Need a roofer in Centennial?" subtitle="Call Gates Enterprises at (720) 766-3377 for a free inspection. We offer the premium warranties and HOA expertise that Centennial homeowners expect." />
      ...
      <section style={{ padding: "32px 24px", background: "#f8f9fb", borderTop: "1px solid rgba(13,33,55,0.06)" }}>
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          ...
          <a href="/best-roofer-centennial" style={{ display: "inline-flex", alignItems: "center", gap: 6, fontFamily: "var(--font-dm-sans), 'DM Sans', sans-serif", fontSize: 15, color: "#1a56a4", fontWeight: 600, textDecoration: "none" }}>
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><polyline points="9 18 15 12 9 6" /></svg>
            Best Roofer in Centennial, CO
          </a>
        </div>
      </section>
