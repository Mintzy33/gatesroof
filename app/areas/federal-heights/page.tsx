...
export const metadata: Metadata = {
  title: `Federal Heights Roofer | 4x Certified, ${SITE_STATS.reviewCount}+ Reviews ★`,
  description: `Federal Heights roofer rated ${SITE_STATS.starRating} stars from ${SITE_STATS.reviewCount}+ Google reviews. Hail repair, full replacements, and premium warranty options. Free inspection available.`,
...
export default function Page() {
  return (
    <>
      <PageSchema route="/areas/federal-heights" />
