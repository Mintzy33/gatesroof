...
export const metadata: Metadata = {
  title: "Federal Heights Roofer | 4x Certified, 308+ Reviews ★",
  description: "Federal Heights roofer rated 4.9 stars from 308+ Google reviews. Hail repair, full replacements, and premium warranty options. Free inspection available.",
