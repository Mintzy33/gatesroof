      ...
      <section style={{ padding: "80px 24px", background: WHITE }}>
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          ...
          <div style={{ marginBottom: 36 }}>
            ...
            <p style={{ fontFamily: "var(--font-dm-sans), 'DM Sans', sans-serif", fontSize: 16, lineHeight: 1.85, color: TEXT_LIGHT }}>
              Reviews tell the real story. Look for a roofer with hundreds of verified Google reviews and a rating above 4.5 stars. Consistent praise across years of reviews indicates reliable quality. Gates Enterprises has accumulated 308+ Google reviews with a 4.8 star average.
            </p>
          </div>
