...
export const metadata: Metadata = {
  ...
  description: "Looking for the best roofer in Broomfield? Gates Enterprises is Colorado's only quadruple certified roofing contractor. 303+ Google reviews, 4.8 stars, free inspections. (720) 766-3377.",
  alternates: { canonical: "https://www.gatesroof.com/best-roofer/broomfield" },
  openGraph: {
    title: "Best Roofer in Broomfield 2026 | Gates Enterprises",
    description: "Looking for the best roofer in Broomfield? Gates Enterprises is Colorado's only quadruple certified roofing contractor. 303+ Google reviews, 4.8 stars.",
