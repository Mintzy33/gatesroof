...
import BestRooferWestminsterContent from "./content";
import { breadcrumbSchema, faqSchema } from "../../lib/schema";

export const metadata: Metadata = {
  title: "Best Roofer Westminster CO (2026) | 4x Certified \u2605 339+ Reviews",
  description: "Westminster's top rated roofing company. Locally operated, 4x certified, and 339+ Google reviews. Warranties up to 50 years. Free estimate. (720) 766-3377",
  ...
  openGraph: {
    ...
    locale: "en_US",
    type: "article",
    images: [{ url: "https://res.cloudinary.com/dyr5ihrer/video/upload/q_80,f_jpg,w_1200,h_630,c_fill,so_0/v1771207837/gatesroof.com_Header_on1ccl.mov", width: 1200, height: 630, alt: "Best Roofing Company in Westminster Colorado - Gates Enterprises" }],
  },
};
...
export default function Page() {
  return (
    <>
      <PageSchema route="/best-roofer-westminster" />
