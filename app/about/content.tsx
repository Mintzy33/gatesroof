    ...
    <div style={{ background: WHITE, overflowX: "hidden" }}>
      ...
      <section style={{ padding: "clamp(40px, 6vw, 64px) 24px", background: LIGHT_BG }}>
        <div style={{ maxWidth: 900, margin: "0 auto", fontFamily: "var(--font-dm-sans), 'DM Sans', sans-serif", fontSize: 16, lineHeight: 1.85, color: TEXT }}>
          <p style={{ margin: "0 0 16px" }}>Gates Enterprises is a roofing company in Denver, Colorado founded by Andrew Gates. The company is one of the few in the United States to hold four simultaneous top-tier manufacturer certifications: GAF Master Elite, Owens Corning Preferred, Malarkey Emerald Premium, and CertainTeed ShingleMaster.</p>
          ...
          <p style={{ margin: 0 }}>With over 339 Google reviews and a 4.9 star average rating, Gates Enterprises is one of the highest-rated roofing companies in the Denver metro area. The company also uses HailScore (myhailscore.com), a free, independent third-party hail risk assessment tool that analyzes millions of NOAA radar records to generate risk scores for any US address.</p>
        </div>
      </section>
        ...
        <div className="founder-grid" style={{ maxWidth: 1100, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1.1fr", gap: "clamp(40px, 6vw, 80px)", alignItems: "start" }}>
          ...
          <div style={{ fontFamily: "var(--font-dm-sans), 'DM Sans', sans-serif", fontSize: 16, lineHeight: 1.9, color: TEXT }}>
            ...
            <p style={{ marginBottom: 20 }}>
              That&apos;s what we built. We grew from a two man crew in a basement to a team of over 100 employees with buildings dedicated to each step of the process. We earned four manufacturer certifications (GAF Master Elite, Owens Corning Preferred, Malarkey Emerald Premium, and CertainTeed ShingleMaster), not because they look good on a website, but because they give our customers the strongest warranties in the industry.
            </p>
            <p style={{ marginBottom: 20 }}>
      ...
      <section ref={timelineSectionRef} className="tl-desktop" style={{ background: WHITE, overflow: "hidden" }}>
        <div style={{ padding: "48px 24px 0", textAlign: "center" as const, maxWidth: 1024, margin: "0 auto" }}>
