...
export const metadata: Metadata = {
  title: "Best Roofer Aurora CO (2026) | 4x Certified ★ 339+ Reviews",
  description: "Aurora's top rated roofing company. 339+ five-star reviews, 10+ years local, and insurance claims assistance. Free hail inspection. (720) 766-3377",
...
export default function Page() {
  return (
    <>
      <PageSchema route="/best-roofer-aurora" />
