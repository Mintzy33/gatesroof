      ...
      <section style={{ padding: "80px 24px", background: WHITE }}>
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          ...
          <div style={{ marginBottom: 36 }}>
            ...
            <p style={{ fontFamily: "var(--font-dm-sans), 'DM Sans', sans-serif", fontSize: 16, lineHeight: 1.85, color: TEXT_LIGHT }}>
              A few five star reviews can be bought or faked. Hundreds cannot. Gates Enterprises has earned 308+ Google reviews with a 4.9 star average over years of consistent work across the Denver metro, including Aurora. That volume of positive feedback reflects genuine, repeatable quality.
            </p>
          </div>
