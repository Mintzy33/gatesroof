...
export const metadata: Metadata = {
  title: "308+ Reviews, 4.9★ | Gates Enterprises LLC",
  description:
    "Read 308+ verified reviews from Colorado homeowners. Rated 4.9 stars on Google. See why families across the Front Range trust Gates Enterprises.",
