...
const FAQS = [
  ...
  { q: "Can you replace siding damaged by a storm?", a: "Absolutely. We repair and replace storm-damaged siding regularly, and we support you through the insurance restoration process. Hail frequently damages siding alongside roofing, and a single claim typically covers both. We document all siding damage as part of our comprehensive exterior inspection." },
