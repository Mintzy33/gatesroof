...
export const metadata: Metadata = {
  ...
  description: "James Hardie, vinyl, and engineered wood siding in Colorado. Boost curb appeal and energy efficiency. 4.9 stars from 308 reviews. Get a free estimate.",
