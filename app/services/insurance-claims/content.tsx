...
const FAQS = [
  ...
  { q: "Can I choose my own contractor for an insurance claim?", a: "Yes. Colorado law gives you the right to choose your own contractor regardless of what your insurance company suggests. Insurance company preferred vendor programs exist to benefit the insurer, not the homeowner. Gates Enterprises works for you, not for the insurance company. We document all damage thoroughly, meet adjusters on site, and put the full scope of work your home needs in front of them in writing." },
  { q: "What if my insurance claim gets denied?", a: "A denial is not always the final answer. We help you understand why coverage was denied and whether a re-inspection or supplement is worth pursuing. In many cases, having a certified contractor present during the adjuster's inspection makes a significant difference in the outcome. If a second look is warranted, we supply the additional documentation: photos, measurements, and manufacturer specifications." },
