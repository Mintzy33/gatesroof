...
const PROCESS_STEPS = [
  ...
  { Icon: Shield, step: "03", title: "Insurance Restoration Support", desc: "We coordinate documentation with your insurance company, providing all necessary documentation to help ensure your restoration is processed smoothly and fairly." },
...
const FAQS = [
  ...
  { q: "Should I file with my insurance for storm damage?", a: "If the damage exceeds your deductible, filing is usually the right move. Colorado is one of the most hail prone states in the country, and most homeowner policies are designed to cover exactly this kind of damage. Our team has helped thousands of homeowners navigate the restoration process from initial inspection through final install. We document everything, meet with your adjuster on site, and support your claim to make sure nothing gets missed." },
