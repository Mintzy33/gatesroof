...
const PROCESS_STEPS = [
  ...
  { Icon: Shield, step: "03", title: "Insurance Claims Assistance", desc: "We assist you through the insurance claims process, providing thorough documentation to help ensure your restoration moves forward smoothly." },
...
const WHY_GATES = [
  { Icon: Award, bold: "Quadruple manufacturer certified.", rest: "GAF Master Elite, CertainTeed ShingleMaster, Owens Corning Preferred, and Malarkey Emerald Premium. Fewer than 1% of contractors in the nation hold all four." },
...
const FAQS = [
  ...
  { q: "Should I file with my insurance for storm damage?", a: "If the damage exceeds your deductible, filing is usually the right move. Colorado is one of the most hail prone states in the country, and most homeowner policies are designed to cover exactly this kind of damage. Our team has helped thousands of homeowners through the restoration process from initial inspection through final install. We document everything thoroughly and assist you through the claims process." },
  ...
  { q: "Will my insurance cover the full cost of repairs?", a: "Whether repairs are covered depends on your specific policy and the cause of damage. We document every detail thoroughly with photos, measurements, and manufacturer specifications to support a complete and fair resolution. If additional documentation is needed, we provide it. We've assisted with over 7,204 roof projects across Colorado." },
  ...
  { q: "Do I need to pay anything out of pocket?", a: "If your claim is approved, your out-of-pocket is typically your policy deductible. The rest may be covered by your policy, depending on your specific coverage. We work with your insurance adjuster to help ensure the scope of work and pricing align so there are no surprises." },
  ...
  { q: "What if my insurance restoration gets denied?", a: "It happens, but it's not always the final answer. We can help you understand why coverage was denied and whether a re-inspection is worth pursuing. Having thorough documentation from a certified contractor can make a significant difference in outcomes." },
    ...
    <div style={{ background: WHITE, overflowX: "hidden" }}>
        ...
        <section style={{ padding: "clamp(64px, 10vw, 100px) 24px", background: WHITE }}>
          <div style={{ maxWidth: 800, margin: "0 auto", textAlign: "center" as const }}>
            ...
            <p style={{ fontFamily: "var(--font-dm-sans), 'DM Sans', sans-serif", fontSize: 17, lineHeight: 1.85, color: TEXT, maxWidth: 700, margin: "0 auto" }}>
              Colorado&apos;s Front Range sees some of the most severe hailstorms in the country. When a storm hits, you need a roofing partner who responds quickly, assesses damage honestly, and delivers lasting results. Gates Enterprises has been helping homeowners recover from storm damage for over 10 years. We assist you through every step from the initial inspection to the final walkthrough, so you can focus on your family while we take care of your home.
            </p>
          </div>
        </section>
      </ScrollReveal>
      ...
      <section style={{ padding: "64px 24px", background: WHITE }}>
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          ...
          <h2 style={{ fontFamily: "var(--font-playfair), 'Playfair Display', Georgia, serif", fontSize: "clamp(24px, 3.5vw, 30px)", fontWeight: 800, color: NAVY, margin: "10px 0 12px" }}>Storm and Hail Damage Guides</h2>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
            {[
              ...
              { t: "Signs of Hail Damage on Your Roof", h: "/blog/signs-of-hail-damage-on-roof" },
              { t: "Signs of Hail Damage From the Ground", h: "/blog/signs-of-hail-damage-from-ground" },
              { t: "Storm Damage Documentation Guide", h: "/blog/storm-damage-documentation-guide" },
              { t: "The Palmer Divide: Colorado's Hail Corridor", h: "/blog/palmer-divide-colorado-hail-corridor" },
              { t: "Post-Storm Roof Inspection Checklist", h: "/blog/post-storm-roof-inspection-checklist-colorado" },
              { t: "Colorado Roof Insurance Claims Guide", h: "/blog/colorado-roof-insurance-claims-guide" },
              { t: "How to File a Hail Damage Insurance Claim", h: "/blog/how-to-file-hail-damage-insurance-claim-colorado" },
            ].map((p) => (
      ...
      <section style={{ padding: "48px 24px", background: WHITE }}>
        <div style={{ maxWidth: 800, margin: "0 auto", textAlign: "center" as const }}>
          ...
          <h2 style={{ fontFamily: "var(--font-playfair), 'Playfair Display', Georgia, serif", fontSize: "clamp(20px, 3vw, 26px)", fontWeight: 800, color: NAVY, margin: "10px 0 12px" }}>Best Roofer Near You After a Hailstorm</h2>
          <p style={{ fontFamily: "var(--font-dm-sans), 'DM Sans', sans-serif", fontSize: 15, color: TEXT_LIGHT, marginBottom: 24, lineHeight: 1.7 }}>Need a certified contractor in your city? See why Gates Enterprises is the top-rated choice across the Front Range.</p>
          <div style={{ display: "flex", flexWrap: "wrap" as const, gap: 8, justifyContent: "center" }}>
            {[
              ...
              { n: "Best Roofer in Broomfield", s: "broomfield" }, { n: "Best Roofer in Fort Collins", s: "fort-collins" }, { n: "Best Roofer in Colorado Springs", s: "colorado-springs" },
            ].map((c) => (
      ...
      <section style={{ padding: "64px 24px", background: LIGHT_BG }}>
        <div style={{ maxWidth: 800, margin: "0 auto", textAlign: "center" as const }}>
          ...
          <h2 style={{ fontFamily: "var(--font-playfair), 'Playfair Display', Georgia, serif", fontSize: "clamp(24px, 3.5vw, 30px)", fontWeight: 800, color: NAVY, margin: "10px 0 12px" }}>Storm & Hail Damage Repair Service Areas</h2>
          <p style={{ fontFamily: "var(--font-dm-sans), 'DM Sans', sans-serif", fontSize: 15, color: TEXT_LIGHT, marginBottom: 24, lineHeight: 1.7 }}>We provide storm and hail damage repair across the Colorado Front Range.</p>
          <div style={{ display: "flex", flexWrap: "wrap" as const, gap: 8, justifyContent: "center" }}>
            {[
