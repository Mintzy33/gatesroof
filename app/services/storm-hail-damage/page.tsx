...
export const metadata: Metadata = {
  ...
  description: "Free hail and storm damage roof inspections across Colorado. Full replacements, insurance claims assistance, 339+ five-star reviews. Call Gates Enterprises today.",
...
const faqSchema = {
  ...
  "mainEntity": [
    ...
    { "@type": "Question", "name": "Will my insurance cover the full cost of repairs?", "acceptedAnswer": { "@type": "Answer", "text": "Whether repairs are covered depends on your specific policy and the cause of damage. We document every detail thoroughly with photos, measurements, and manufacturer specifications to support a complete and fair resolution. If additional documentation is needed, we provide it." } },
