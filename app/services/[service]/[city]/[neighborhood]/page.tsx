...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const description = `${service.service} in ${neighborhood.name}, ${city.city}, Colorado. ${neighborhood.housingAge} homes with ${neighborhood.commonRoofTypes.toLowerCase()}. 4x manufacturer certified, 4.9 stars, 308 Reviews. Free estimates.`;
...
function generateNeighborhoodFAQs(
  ...
  const faqs: FAQPair[] = [
    ...
    },
    {
      ...
      a: `Yes. Gates Enterprises provides ${s.service.toLowerCase()} throughout ${n.name} and all of ${c.city}. With thousands of completed projects across Colorado's Front Range and a 4.9-star rating from 308 Google reviews, we bring certified quality to every ${n.name} project. Call (720) 766-3377 or visit our contact page to schedule a free estimate.`,
    },
    {
