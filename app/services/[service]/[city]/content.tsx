...
function getWhyChoose(city: CityData, service: ServiceData): string[] {
  const base = [
    ...
    `303 Google reviews with a 4.8-star rating from Colorado homeowners`,
    ...
    <div style={{ background: WHITE }}>
      ...
      >
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          ...
          >
            {city.county} County · Quadruple Manufacturer Certified · 303 Reviews · 4.8★
          </p>
      ...
      <CTA
        ...
        subtitle={`Call Gates Enterprises at (720) 766-3377 for a free inspection and estimate. Quadruple manufacturer certified. 303 Google reviews, 4.8 stars. Serving ${city.city} and all of ${city.county} County.`}
      />
