...
const faqSchema = {
  ...
  "mainEntity": [
    ...
    {"@type": "Question", "name": "Does homeowners insurance cover roof replacement?", "acceptedAnswer": {"@type": "Answer", "text": "Insurance may cover roof replacement when the damage was caused by a covered event like hail, wind, or fallen debris, depending on your policy and the adjuster's assessment. If your roof reached end of life from normal wear, that is typically not covered. A free inspection will determine if your damage is claim-worthy."}},
