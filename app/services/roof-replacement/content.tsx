...
const FAQS = [
  ...
  { q: "Does homeowners insurance cover roof replacement?", a: "Insurance covers roof replacement when the damage was caused by a covered event like hail, wind, or fallen debris. In Colorado's hail corridor, the majority of roof replacements are insurance-covered because most roofs have documented storm damage. If your roof simply reached end of life from normal wear, that is typically not covered. A free inspection from Gates Enterprises will determine if your damage is claim-worthy." },
  ...
  { q: "What certifications should my roofer have?", a: "Manufacturer certifications determine your warranty options and ensure proper installation. An uncertified contractor can only offer a basic manufacturer warranty. Gates Enterprises holds four premium certifications: GAF Master Elite, Owens Corning Preferred, Malarkey Emerald Premium, and CertainTeed Shingle Master. Fewer than 2% of roofers nationwide hold even one of these credentials. These certifications give you access to the strongest warranty tiers available." },
    ...
    <div style={{ background: WHITE, overflowX: "hidden" }}>
      ...
      <section style={{ padding: "48px 24px", background: WHITE }}>
        <div style={{ maxWidth: 800, margin: "0 auto", textAlign: "center" as const }}>
          ...
          <p style={{ fontFamily: "var(--font-dm-sans), 'DM Sans', sans-serif", fontSize: 15, color: TEXT_LIGHT, marginBottom: 24, lineHeight: 1.7 }}>GAF Master Elite, Owens Corning Preferred, and 308 five-star reviews. Find out why we are the top-rated replacement contractor in your city.</p>
          <div style={{ display: "flex", flexWrap: "wrap" as const, gap: 8, justifyContent: "center" }}>
            {[
              ...
              { n: "Best Roofer in Longmont", s: "longmont" }, { n: "Best Roofer in Fort Collins", s: "fort-collins" }, { n: "Best Roofer in Colorado Springs", s: "colorado-springs" },
            ].map((c) => (
      ...
      <section style={{ padding: "64px 24px", background: LIGHT_BG }}>
        <div style={{ maxWidth: 800, margin: "0 auto", textAlign: "center" as const }}>
          ...
          <h2 style={{ fontFamily: "var(--font-playfair), 'Playfair Display', Georgia, serif", fontSize: "clamp(24px, 3.5vw, 30px)", fontWeight: 800, color: NAVY, margin: "10px 0 12px" }}>Roof Replacement Service Areas</h2>
