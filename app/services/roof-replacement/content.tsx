...
const WHY_GATES = [
  { Icon: Award, bold: "Quadruple manufacturer certified.", rest: "GAF Master Elite, CertainTeed ShingleMaster, Owens Corning Preferred, and Malarkey Emerald Premium. No other local contractor holds all four." },
