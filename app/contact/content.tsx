...
export default function ContactContent() {
  ...
  const inp = { width:"100%",padding:"16px 20px",borderRadius:12,border:"1.5px solid rgba(13,33,55,0.1)",background:WHITE,fontFamily:"'DM Sans', sans-serif",fontSize:15,color:TEXT,outline:"none",boxSizing:"border-box" as const };
  return (
    <div style={{background:WHITE}}>
      <Header />
      <section style={{padding:"160px 24px 80px",background:`linear-gradient(170deg, ${NAVY} 0%, #0F2A42 100%)`,textAlign:"center" as const}}>
        <span style={{fontFamily:"'DM Sans', sans-serif",fontSize:12,fontWeight:700,color:GOLD,letterSpacing:"0.2em"}}>CONTACT US</span>
        <h1 style={{fontFamily:"'Playfair Display', Georgia, serif",fontSize:"clamp(36px, 5vw, 56px)",fontWeight:800,color:WHITE,margin:"14px 0 20px"}}>Get Your Free Inspection</h1>
        <p style={{fontFamily:"'DM Sans', sans-serif",fontSize:18,color:"rgba(255,255,255,0.7)",maxWidth:550,margin:"0 auto",lineHeight:1.75}}>Fill out the form below and we&apos;ll get back to you within 24 hours. Or call us directly.</p>
      </section>
        ...
        <div style={{maxWidth:1100,margin:"0 auto",display:"grid",gridTemplateColumns:"1.2fr 1fr",gap:80}}>
          <div>
            {sent ? (
              <div style={{background:LIGHT_BG,borderRadius:24,padding:60,textAlign:"center" as const,border:"1px solid rgba(59,125,216,0.1)"}}>
                ...
                <h3 style={{fontFamily:"'Playfair Display', Georgia, serif",fontSize:28,fontWeight:800,color:NAVY,margin:"20px 0 12px"}}>Thank You!</h3>
                <p style={{fontFamily:"'DM Sans', sans-serif",fontSize:16,color:TEXT_LIGHT,lineHeight:1.7}}>We&apos;ve received your request. A Gates team member will contact you within 24 hours.</p>
              </div>
            ) : (
              <div>
                <h2 style={{fontFamily:"'Playfair Display', Georgia, serif",fontSize:28,fontWeight:800,color:NAVY,marginBottom:8}}>Request a Free Estimate</h2>
                <p style={{fontFamily:"'DM Sans', sans-serif",fontSize:15,color:TEXT_LIGHT,marginBottom:36}}>No obligation. No pressure. Just an honest assessment.</p>
          ...
          <div>
            <div style={{background:LIGHT_BG,borderRadius:24,padding:"40px 36px",marginBottom:24,border:"1px solid rgba(13,33,55,0.04)"}}>
              <h3 style={{fontFamily:"'Playfair Display', Georgia, serif",fontSize:20,fontWeight:700,color:NAVY,marginBottom:24}}>Contact Info</h3>
            ...
            <div style={{background:LIGHT_BG,borderRadius:24,padding:"40px 36px",marginBottom:24,border:"1px solid rgba(13,33,55,0.04)"}}>
              <h3 style={{fontFamily:"'Playfair Display', Georgia, serif",fontSize:20,fontWeight:700,color:NAVY,marginBottom:16}}>Business Hours</h3>
              <div style={{fontFamily:"'DM Sans', sans-serif",fontSize:15,color:TEXT_LIGHT,lineHeight:2}}>Monday – Friday: 7:00 AM – 6:00 PM<br/>Saturday: 8:00 AM – 2:00 PM<br/>Sunday: Closed<br/><span style={{color:ACCENT,fontWeight:600}}>24/7 Emergency Service Available</span></div>
            </div>
