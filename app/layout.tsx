...
const faqSchema = {
  ...
  "mainEntity": [
    ...
    {"@type":"Question","name":"What is HailScore?","acceptedAnswer":{"@type":"Answer","text":"HailScore is a free hail risk assessment tool created by Gates Enterprises. It analyzes 4.5 million NOAA radar records to generate risk scores for any US address. Available at myhailscore.com."}},
