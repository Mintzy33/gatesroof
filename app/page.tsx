            ...
            <ScrollReveal delay={0.3} direction="left">
              <div style={{ background: "rgba(255,255,255,0.06)", border: "1px solid rgba(255,255,255,0.12)", borderRadius: 20, padding: "28px 28px", backdropFilter: "blur(16px)", WebkitBackdropFilter: "blur(16px)", marginBottom: 16, boxShadow: "0 8px 32px rgba(37,99,235,0.15), 0 0 60px rgba(37,99,235,0.06), inset 0 1px 0 rgba(255,255,255,0.08)" }}>
                <div className="hero-stats" style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 20 }}>
                  {[{ n: SITE_STATS.totalRoofsNumber, s: "+", l: "Roofs" }, { n: SITE_STATS.yearsExperienceNumber, s: "+", l: "Years" }, { n: 0, s: "", l: "Rating", star: true }].map((s, i) => (
                    <div key={i} style={{ textAlign: "center" as const }}>
                      <div style={{ fontFamily: "var(--font-playfair), 'Playfair Display', Georgia, serif", fontSize: 32, fontWeight: 800, color: WHITE, lineHeight: 1 }}>{s.star ? <span style={{ color: GOLD }}>{SITE_STATS.starRating}★</span> : <CounterGSAP end={s.n} suffix={s.s} duration={2.2} delay={0.8} />}</div>
            ...
            <div>
              ...
              <ScrollReveal delay={0.1}>
                <div style={{ display: "flex", gap: 28 }}>
                  {[{ n: SITE_STATS.totalRoofsNumber, s: "+", l: "Roofs", dur: 2.2 }, { n: SITE_STATS.yearsExperienceNumber, s: "+", l: "Years", dur: 2.2 }, { n: 0, s: "", l: "Rating", dur: 0, star: true }].map((s, i) => (
                    <div key={i}>
                      <div style={{ fontFamily: "var(--font-playfair), 'Playfair Display', Georgia, serif", fontSize: "clamp(26px, 3vw, 34px)", fontWeight: 800, color: NAVY }}>
                        {s.star ? <><span style={{ color: GOLD }}>{SITE_STATS.starRating}</span><span style={{ color: GOLD }}>★</span></> : <CounterGSAP end={s.n} suffix={s.s} duration={s.dur} />}
                      </div>
      ...
      <section style={{ padding: "clamp(56px, 10vw, 100px) 20px", background: WHITE }}>
        <div style={{ maxWidth: 900, margin: "0 auto", textAlign: "center" as const }}>
          <ScrollReveal>
            ...
            <p style={{ fontFamily: "var(--font-dm-sans), 'DM Sans', sans-serif", fontSize: "clamp(14px, 2vw, 16px)", color: TEXT_LIGHT, maxWidth: 680, margin: "0 auto 40px", lineHeight: 1.8 }}>Colorado ranks #1 in the nation for hail damage insurance claims. The Front Range sees damaging hailstorms every spring and summer, with stones regularly exceeding golf ball size. Many homeowners don&apos;t realize their roof has storm damage until leaks appear years later. A proactive inspection after every major storm is the single best way to protect your home&apos;s value — and an approved insurance claim may cover much of the repair cost, depending on your policy.</p>
          </ScrollReveal>
          ...
          <ScrollReveal>
            <div style={{ textAlign: "center" as const, marginBottom: "clamp(32px, 5vw, 56px)" }}>
              ...
              <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 6 }}>
                ...
                <a href="https://www.google.com/maps/place/Gates+Enterprises" target="_blank" rel="noopener noreferrer" style={{ fontFamily: "var(--font-dm-sans), 'DM Sans', sans-serif", fontSize: 14, color: TEXT_LIGHT, textDecoration: "none", borderBottom: "1px solid rgba(100,116,139,0.3)", transition: "color 0.2s" }}>{SITE_STATS.starRating} stars from {SITE_STATS.reviewCount}+ Google Reviews</a>
              </div>
            </div>
          </ScrollReveal>
          <ReviewCarousel />
