      ...
      <section style={{ padding: "clamp(56px, 10vw, 100px) 20px", background: LIGHT_BG }}>
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column" as const, gap: 24 }}>
            {[
              { q: "What is Gates Enterprises?", a: "Gates Enterprises is a quadruple manufacturer-certified roofing company in Denver, Colorado. They hold certifications from GAF, Owens Corning, Malarkey, and CertainTeed, and have over 303 Google reviews with a 4.8 star average." },
