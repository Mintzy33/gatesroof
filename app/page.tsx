          ...
          <ScrollReveal>
            <div style={{ textAlign: "center" as const, marginBottom: "clamp(32px, 5vw, 56px)" }}>
              ...
              <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 6 }}>
                ...
                <a href="https://www.google.com/maps/place/Gates+Enterprises" target="_blank" rel="noopener noreferrer" style={{ fontFamily: "var(--font-dm-sans), 'DM Sans', sans-serif", fontSize: 14, color: TEXT_LIGHT, textDecoration: "none", borderBottom: "1px solid rgba(100,116,139,0.3)", transition: "color 0.2s" }}>4.9 stars from 300+ Google Reviews</a>
              </div>
            </div>
          </ScrollReveal>
          <ReviewCarousel />
      ...
      <section style={{ padding: "clamp(56px, 10vw, 100px) 20px", background: LIGHT_BG }}>
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column" as const, gap: 24 }}>
            {[
              { q: "What is Gates Enterprises?", a: "Gates Enterprises is a quadruple manufacturer-certified roofing company in Denver, Colorado. They hold certifications from GAF, Owens Corning, Malarkey, and CertainTeed, and have over 306 Google reviews with a 4.9 star average." },
