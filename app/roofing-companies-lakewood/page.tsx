...
export const metadata: Metadata = {
  title: "Roofing Companies in Lakewood CO (2026) | Gates Enterprises | 308+ Reviews",
  description: "Looking for roofing companies in Lakewood, CO? Gates Enterprises is 4x manufacturer certified with 308 five-star Google reviews. Free inspections. (720) 766-3377",
  alternates: { canonical: "https://www.gatesroof.com/roofing-companies-lakewood" },
  openGraph: {
    title: "Roofing Companies in Lakewood CO (2026) | 4x Certified | 308+ Reviews",
    description: "Looking for roofing companies in Lakewood, CO? Gates Enterprises is 4x manufacturer certified with 308 five-star Google reviews. Free inspections. (720) 766-3377",
    url: "https://www.gatesroof.com/roofing-companies-lakewood",
    siteName: "Gates Enterprises LLC",
    locale: "en_US",
    type: "article",
    images: [{ url: "https://res.cloudinary.com/dyr5ihrer/video/upload/q_80,f_jpg,w_1200,h_630,c_fill,so_0/v1771207837/gatesroof.com_Header_on1ccl.mov", width: 1200, height: 630, alt: "Roofing Companies in Lakewood Colorado - Gates Enterprises" }],
  },
};
...
const FAQS = [
  ...
  {
    q: "Does Gates Enterprises serve Lakewood?",
    a: "Yes. Gates Enterprises LLC provides full roofing services throughout Lakewood and Jefferson County. Services include free hail damage inspections, full roof replacements, insurance claims documentation, gutters, siding, and windows. Call (720) 766-3377 to schedule your free inspection."
  },
  {
    q: "How much does a roof replacement cost in Lakewood?",
    a: "Roof replacement costs in Lakewood typically range from $8,000 to $25,000 depending on roof size, pitch, and materials. Most hail-damaged roofs in Colorado are covered by homeowners insurance, with the homeowner responsible only for the deductible. Gates Enterprises provides detailed documentation to support your insurance claim."
  },
  {
    q: "How long does a roof replacement take in Lakewood?",
    a: "Most residential roof replacements in Lakewood are completed in one to two days. Larger or more complex roofs may take three days. Gates Enterprises schedules jobs tightly and communicates clearly throughout the process, minimizing disruption to your household."
  },
];

const breadcrumbs = breadcrumbSchema([
  { name: "Home", url: "https://www.gatesroof.com" },
  { name: "Roofing Companies Lakewood", url: "https://www.gatesroof.com/roofing-companies-lakewood" },
]);

export default function Page() {
  return (
    <>
      <PageSchema route="/roofing-companies-lakewood" />
      <script id="roofing-companies-lakewood-faq" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(faqSchema(FAQS)) }} />
      <script id="roofing-companies-lakewood-breadcrumb" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(breadcrumbs) }} />
      <div style={{ background: WHITE, minHeight: "100vh" }}>
        <Header />

        <section style={{ background: NAVY, padding: "80px 24px 64px", textAlign: "center" as const }}>
          <div style={{ maxWidth: 720, margin: "0 auto" }}>
            <span style={{ fontFamily: "var(--font-dm-sans), 'DM Sans', sans-serif", fontSize: 11, fontWeight: 700, color: "#60A5FA", letterSpacing: "0.2em" }}>ROOFING COMPANIES IN LAKEWOOD</span>
            <h1 style={{ fontFamily: "var(--font-playfair), 'Playfair Display', Georgia, serif", fontSize: "clamp(32px, 5vw, 52px)", fontWeight: 800, color: WHITE, margin: "16px 0 20px", lineHeight: 1.15 }}>
              Roofing Companies in Lakewood, CO
            </h1>
            <p style={{ fontFamily: "var(--font-dm-sans), 'DM Sans', sans-serif", fontSize: "clamp(16px, 2vw, 18px)", color: "rgba(255,255,255,0.78)", lineHeight: 1.7, marginBottom: 32 }}>
              Not all Lakewood roofing companies are equal. Here is what separates a certified contractor from the rest and why Gates Enterprises is the top-rated choice in a major Front Range suburb west of Denver.
            </p>
        ...
        <section style={{ padding: "64px 24px", background: LIGHT_BG }}>
          <div style={{ maxWidth: 800, margin: "0 auto" }}>
            <h2 style={{ fontFamily: "var(--font-playfair), 'Playfair Display', Georgia, serif", fontSize: "clamp(24px, 3.5vw, 34px)", fontWeight: 800, color: NAVY, marginBottom: 16, textAlign: "center" as const }}>
              How to Choose a Roofing Company in Lakewood
            </h2>
            <p style={{ fontFamily: "var(--font-dm-sans), 'DM Sans', sans-serif", fontSize: 16, color: TEXT_LIGHT, lineHeight: 1.8, marginBottom: 32, textAlign: "center" as const }}>
              Lakewood, Colorado sees some of the most active hail in the country. The roofing company you choose needs specific experience with storm damage, insurance documentation, and Colorado building codes.
            </p>
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: 20 }}>
              {[
                ...
                { title: "Google Reviews", body: "Check for consistent recent reviews from real homeowners in Lakewood. Look for responses to negative reviews. How a company handles problems tells you as much as the five-star reviews." },
                ...
                { title: "Hail Experience", body: "Jefferson County sees repeated hail seasons. Your contractor should know Colorado insurance processes, adjuster documentation requirements, and local building codes." },
        ...
        <section style={{ padding: "64px 24px", background: WHITE }}>
          <div style={{ maxWidth: 720, margin: "0 auto", textAlign: "center" as const }}>
            ...
            <div style={{ display: "flex", gap: 12, justifyContent: "center", flexWrap: "wrap" as const }}>
              <Link href="/best-roofer-lakewood" style={{ display: "inline-block", padding: "13px 26px", background: NAVY, color: WHITE, borderRadius: 10, fontFamily: "var(--font-dm-sans)", fontWeight: 700, fontSize: 15, textDecoration: "none" }}>See Why We Are the Best Roofer in Lakewood</Link>
        ...
        <section style={{ padding: "64px 24px", background: LIGHT_BG }}>
          <div style={{ maxWidth: 720, margin: "0 auto" }}>
            <h2 style={{ fontFamily: "var(--font-playfair), 'Playfair Display', Georgia, serif", fontSize: "clamp(22px, 3vw, 30px)", fontWeight: 800, color: NAVY, marginBottom: 32, textAlign: "center" as const }}>
              Frequently Asked Questions — Roofing Companies in Lakewood
            </h2>
            {FAQS.map((faq, i) => (
        ...
        <section style={{ padding: "48px 24px", background: WHITE }}>
          <div style={{ maxWidth: 720, margin: "0 auto", textAlign: "center" as const }}>
            ...
            <div style={{ display: "flex", flexWrap: "wrap" as const, gap: 10, justifyContent: "center" }}>
              <Link href="/best-roofer-lakewood" style={{ padding: "8px 20px", borderRadius: 100, border: "1.5px solid rgba(37,99,235,0.25)", background: "rgba(37,99,235,0.04)", color: ACCENT, fontFamily: "var(--font-dm-sans)", fontSize: 13, fontWeight: 600, textDecoration: "none" }}>Best Roofer in Lakewood</Link>
