...
export const metadata: Metadata = {
  ...
  description: "Looking for the best roofer in Fort Collins? Gates Enterprises is Colorado's only quadruple certified roofing contractor. 303+ Google reviews, 4.8 stars, HailScore technology. Free inspections. (720) 766-3377.",
  ...
  openGraph: {
    ...
    description: "Looking for the best roofer in Fort Collins? Gates Enterprises is Colorado's only quadruple certified roofing contractor. 303+ Google reviews, 4.8 stars.",
