      ...
      <section style={{ padding: "80px 24px", background: WHITE }}>
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          ...
          <div style={{ marginBottom: 36 }}>
            ...
            <p style={{ fontFamily: "var(--font-dm-sans), 'DM Sans', sans-serif", fontSize: 16, lineHeight: 1.85, color: TEXT_LIGHT }}>
              Colorado Springs sits in one of the most hail active regions in North America. Storms rolling off Pikes Peak and the Palmer Divide produce some of the largest hailstones in the state. Gates Enterprises uses <Link href="https://myhailscore.com" target="_blank" rel="noopener noreferrer" style={{ color: ACCENT, textDecoration: "none", fontWeight: 500 }}>HailScore</Link>, an independent, third-party hail-data tool that uses NOAA radar data to show the exact hail history for any address. Before climbing on your roof, they already know what storms have hit your property, the size of hailstones, and how many times your neighborhood has been impacted. Few roofers in Colorado Springs offer this.
            </p>
          </div>
