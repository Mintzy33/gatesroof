...
const descriptionVariants: Record<string, ((city: string) => string)[]> = {
  "roof-replacement": [
    ...
    (c) =>
      `Trusted roof replacement in ${c}, Colorado from Gates Enterprises. 4.9 stars, 7,200+ projects completed. Premium shingles with top tier warranties.`,
    (c) =>
    ...
    (c) =>
      `Top rated roof replacement in ${c}, CO by Gates Enterprises. 4.9 star reviews, manufacturer certified, and backed by the best warranties in the industry.`,
  ],
  "storm-hail-damage": [
    (c) =>
      `Hail damage in ${c}? Gates Enterprises offers free storm inspections and full insurance claim support. Quadruple certified with 4.9 stars and 7,200+ projects.`,
    (c) =>
  ...
  "roof-repair": [
    (c) =>
      `Fast roof repair in ${c}, CO from Gates Enterprises. Leaks, missing shingles, and storm damage fixed right. Quadruple certified, 4.9 stars, same week service.`,
    (c) =>
      `Gates Enterprises offers professional roof repair in ${c}, Colorado. 7,200+ projects completed, 4.9 star reviews. Honest assessments and lasting repairs.`,
    (c) =>
      `Roof repair in ${c}? Gates Enterprises provides same week appointments and certified workmanship. 4.9 stars across 7,200+ completed roofing projects in CO.`,
    (c) =>
  ...
  "siding": [
    (c) =>
      `Siding installation and repair in ${c} by Gates Enterprises. James Hardie certified installer with 4.9 stars and 7,200+ exterior projects across Colorado.`,
    (c) =>
    ...
    (c) =>
      `${c} siding services from Gates Enterprises. James Hardie fiber cement, vinyl, and more. 4.9 star rated with 7,200+ projects. Free estimates and financing.`,
    (c) =>
      `Professional siding replacement in ${c}, Colorado. Gates Enterprises is quadruple certified with 4.9 stars. Storm damage repairs and full installs available.`,
  ],
  "gutters": [
    (c) =>
      `Gutter installation in ${c}, Colorado by Gates Enterprises. Seamless aluminum gutters and gutter guards. 4.9 stars, 7,200+ projects. Free estimates today.`,
    (c) =>
    ...
    (c) =>
      `${c} gutter services from Gates Enterprises. Seamless aluminum, gutter guards, and downspout routing. 4.9 star rated contractor with 7,200+ projects in CO.`,
  ],
  "roof-inspection": [
    (c) =>
      `Free roof inspection in ${c}, CO from Gates Enterprises. Detailed photo reports for storm damage, real estate, or maintenance. Quadruple certified, 4.9 stars.`,
    (c) =>
    ...
    (c) =>
      `Schedule a free roof inspection in ${c} with Gates Enterprises. Quadruple manufacturer certified, 4.9 star reviews. We document everything with photos.`,
    (c) =>
      `${c} roof inspection by Gates Enterprises. Free storm damage assessments and buyer/seller inspections. 4.9 stars, 7,200+ projects. Book online or call today.`,
  ],
  "insurance-claims": [
    (c) =>
  ...
  "metal-roofing": [
    (c) =>
      `Metal roofing in ${c}, CO by Gates Enterprises. Standing seam and metal shingle systems with 50 year warranties. Quadruple certified, 4.9 stars. Free quotes.`,
    (c) =>
      `Gates Enterprises installs metal roofing in ${c}, Colorado. Maximum hail protection, 50 year lifespan, and energy savings. 7,200+ projects, 4.9 star rated.`,
    (c) =>
...
export function getMetaDescription(service: ServiceData, city: CityData): string {
  ...
  return `${hailPrefix}${service.service} in ${city.city}, Colorado by Gates Enterprises. Quadruple manufacturer certified. 4.9 stars, 7,200+ projects. Free estimates.`;
}
