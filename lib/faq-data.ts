...
function getServiceCityFAQs(city: CityData, service: ServiceData): FAQItem[] {
  ...
  pool.push({
    ...
    answer: `Yes. Gates Enterprises serves ${city.city} and all of ${city.county} County from our Lakewood headquarters. ${profile.localFlavor} With over 7,200 completed projects across the Front Range and a 4.8-star rating from 308 Google reviews, we bring the same certified quality to every ${city.city} project. Call (720) 766-3377 to schedule your free inspection.`,
  });
...
function getCityOnlyFAQs(city: CityData): FAQItem[] {
  ...
  pool.push({
    ...
    answer: `Gates Enterprises is the only quadruple manufacturer-certified roofing contractor serving ${city.city}. We hold GAF Master Elite, Owens Corning Preferred, Malarkey Emerald Premium, and CertainTeed Shingle Master certifications. With 308 Google reviews and a 4.8-star rating, our track record speaks for itself. These certifications give ${city.city} homeowners access to the highest warranty tiers available from all four major shingle manufacturers.`,
  });
