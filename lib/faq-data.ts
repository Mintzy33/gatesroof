...
function getServiceCityFAQs(city: CityData, service: ServiceData): FAQItem[] {
  ...
  pool.push({
    ...
    answer: `Yes. Gates Enterprises serves ${city.city} and all of ${city.county} County from our Lakewood headquarters. ${profile.localFlavor} With over 7,200 completed projects across the Front Range and a 4.8-star rating from 306 Google reviews, we bring the same certified quality to every ${city.city} project. Call (720) 766-3377 to schedule your free inspection.`,
  });
